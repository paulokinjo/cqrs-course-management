...
public static class ApiClient
{
    ...
    {
        Result result = await SendRequest<string>(string.Empty, HttpMethod.Post, dto).ConfigureAwait(false);
        return result;
    }
         ...
         where T : class
    {
        ...
        var envelope = JsonSerializer.Deserialize<Envelope<T>>(response, new JsonSerializerOptions { PropertyNameCaseInsensitive = true });
